...
function guardarProducto(){
	...
	var fecha = $('#fecha').val();  	
	$.ajax({
		url: 'productos/new2.php',
		cache: false,
		type: "POST",
		data: "&codigo="+codigo+"&nombre="+nombre+"&marca="+marca+"&almacen="+almacen+"&descripcion="+descripcion+"&cantidad="+cantidad+"&precio="+precio+"&fecha="+fecha,
...
function actualizarProducto(){
	...
	var precio = $('#precio').val();  		
	$.ajax({
		url: 'productos/update2.php',
		cache: false,
		type: "POST",
		data: "&codigo="+codigo+"&nombre="+nombre+"&marca="+marca+"&almacen="+almacen+"&descripcion="+descripcion+"&cantidad="+cantidad+"&precio="+precio,
		success: function(datos){
			$("#main-content").html(datos);
		}
	});
...
function abrirFormulario1(){
		$.ajax({
			url: 'FormularioCaptura.html',
			cache: false,
			type: "GET",
			success: function(datos){
				$("#CapaDestino").html(datos);
			}
		});
	}
...
function callFormulario(formulario_a_abrir){
		$.ajax({
			url: 'productos/'+formulario_a_abrir,
			cache: false,
			type: "GET",
			success: function(datos){
				$("#main-content").html(datos);
...
function CallGuardaLegal(){
		...
		$.ajax({
			...
			cache: false,
			type: "POST",
			data: "operacion="+operacion+"&descripcion="+descripcion+"&tipodeproblema="+tipodeproblema+"&fecha="+fecha+"&status="+status+"&observacion="+observacion,
			success: function(datos){
...
function CallGuardaLogic(){
		...
		$.ajax({
			...
			cache: false,
			type: "POST",
			data: "operacion="+operacion+"&IDVENTA="+IDVENTA+"&IDCLIENTE="+IDCLIENTE+"&direccion="+direccion+"&telefono="+telefono+"&fechanevio="+fechaenvio+"&estadodelenvio="+estadodelenvio+"&tipoenvio="+tipoenvio+"&observaciones="+observaciones,
			success: function(datos){
				$("#informacion").html(datos);
			}
		});
